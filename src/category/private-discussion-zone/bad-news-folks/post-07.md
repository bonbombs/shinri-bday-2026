...
date: "1996-06-15T18:05:22.1Z" # timestamp should be day after previous post
category: Private Discussion Zone
permalink: "/category/{{ category | slugify }}/{{ thread }}/thread/index.html#{{ page.fileSlug | slugify }}"
---

Yeah, from what I can tell, usually there’s some sort of ransom delivered or an expression of intent if not immediate and straight up vandalism of some sort.

What’s really strange is that there’s been no follow-up at all. I’ve been sent no demands, there’s been no attempts to hack any other of my personal accounts so far, and there’s no (as far as I can tell) vandalism at all on the forum.
